...
public class PythonUI extends HorizontalSplitPanel implements View {
	...
	private Button teht1 = new Button("Teht‰v‰ 1");
	private Button teht2 = new Button("Teht‰v‰ 2");
	private Button teht3 = new Button("Teht‰v‰ 3");
	private Button teht4 = new Button("Teht‰v‰ 4");
    ...
    public void initLayout() {
        ...
        Link lnk = new Link("Editorin‰kym‰‰n", new ExternalResource("#!" + Editori.NAME));
